...
if file:
    ...
    model = load_learner("pnev_model.pkl")
...
with st.expander("Sayt haqida"):
    st.markdown("""
                ##### Vazifa :
                Mening sun'iy intellekt saytim, X-Ray rasmlar orqali pnevmoniya chalingan va sog'lom insonni ajrata oladigan innovatsion texnologiyaga asoslangan. Bu sayt, tibbiy tahlil va tashhis jarayonlarini yanada tezroq va samarali qilish maqsadida yaratilgan.

                ##### Maqsad :
                Mening maqsadim, xronik tibbiy muammolar kabi jiddiy vaziyatlarda tibbiy tahlil va tekshirishlarni tez va samarali tashkil qilish orqali dunyo bo'ylab sog'lomlikni oshirishga yordam berishdir.
                """)
